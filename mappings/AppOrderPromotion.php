...
$metadata->mapField(array(
   'fieldName' => 'upaderDate',
   'columnName' => 'upader_date',
   'type' => 'text',
   'nullable' => true,
   'length' => NULL,
   'options' => 
...
$metadata->mapField(array(
   'fieldName' => 'minUnitsDiscount',
   'columnName' => 'min_units_discount',
   'type' => 'float',
   'nullable' => true,
   'precision' => 10,
   'scale' => 0,
...
$metadata->mapField(array(
   'fieldName' => 'unitsForFree',
   'columnName' => 'units_for_free',
   'type' => 'integer',
   'nullable' => true,
   'options' => 
   array(
