 ...
 * BaseLanguage
 *
 * @ORM\Table(name="base_language")
 * @ORM\Entity(repositoryClass="AppBundle\Entities\BaseLanguage")
 */
class BaseLanguage
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="code_iso", type="text", precision=0, scale=0, nullable=true, unique=false)
     */
    private $codeIso;
