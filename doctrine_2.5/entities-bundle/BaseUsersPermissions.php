 ...
 * @ORM\Entity(repositoryClass="AppBundle\Entities\BaseUsersPermissions")
 */
class BaseUsersPermissions
{
     ...
     * @var integer
     *
     * @ORM\Column(name="id_module", type="integer", precision=0, scale=0, nullable=true, unique=false)
     */
    private $idModule;
