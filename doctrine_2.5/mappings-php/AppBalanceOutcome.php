...
$metadata->mapField(array(
   'fieldName' => 'subtotalBusiness',
   'columnName' => 'subtotal_business',
   'type' => 'float',
   'nullable' => true,
   'precision' => 10,
   'scale' => 0,
...
$metadata->mapField(array(
   'fieldName' => 'subtotalOwn',
   'columnName' => 'subtotal_own',
   'type' => 'float',
   'nullable' => true,
   'precision' => 10,
   'scale' => 0,
