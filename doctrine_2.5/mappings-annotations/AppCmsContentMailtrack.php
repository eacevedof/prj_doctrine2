...
/**
 * AppCmsContentMailtrack
 *
 * @ORM\Table(name="app_cms_content_mailtrack")
 * @ORM\Entity
 */
class AppCmsContentMailtrack
{
    /**
     * @var integer
     *
     ...
     * @var string
     *
     * @ORM\Column(name="is_sent", type="text", nullable=true)
     */
    private $isSent;
     ...
     * @var string
     *
     * @ORM\Column(name="tokendelete", type="text", nullable=true)
     */
    private $tokendelete;
