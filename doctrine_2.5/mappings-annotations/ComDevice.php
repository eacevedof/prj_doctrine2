...
class ComDevice
{
     ...
     * @var integer
     *
     * @ORM\Column(name="id_platform", type="integer", nullable=true)
     */
    private $idPlatform;
     ...
     * @var string
     *
     * @ORM\Column(name="app_version", type="text", nullable=true)
     */
    private $appVersion;
     ...
     * @var string
     *
     * @ORM\Column(name="os_version", type="text", nullable=true)
     */
    private $osVersion;
     ...
     * @var string
     *
     * @ORM\Column(name="sim", type="text", nullable=true)
     */
    private $sim;
