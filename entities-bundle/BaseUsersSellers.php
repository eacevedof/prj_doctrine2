 ...
 * BaseUsersSellers
 *
 * @ORM\Table(name="base_users_sellers")
 * @ORM\Entity
 */
class BaseUsersSellers
{
    /**
     * @var integer
     *
     ...
     * @var integer
     *
     * @ORM\Column(name="id_seller", type="integer", precision=0, scale=0, nullable=true, unique=false)
     */
    private $idSeller;
