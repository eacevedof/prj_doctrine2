...
class BaseSecurityIp
{
     ...
     * @var string
     *
     * @ORM\Column(name="is_blocked", type="text", precision=0, scale=0, nullable=true, unique=false)
     */
    private $isBlocked;
     ...
     * @var string
     *
     * @ORM\Column(name="reason", type="text", precision=0, scale=0, nullable=true, unique=false)
     */
    private $reason;
