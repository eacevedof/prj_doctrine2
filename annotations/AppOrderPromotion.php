 ...
 * AppOrderPromotion
 *
 * @ORM\Table(name="app_order_promotion")
 * @ORM\Entity
 */
class AppOrderPromotion
{
     ...
     * @var string
     *
     * @ORM\Column(name="upader_date", type="text", nullable=true)
     */
    private $upaderDate;
     ...
     * @var integer
     *
     * @ORM\Column(name="min_units", type="integer", nullable=true)
     */
    private $minUnits;
     ...
     * @var float
     *
     * @ORM\Column(name="min_units_discount", type="float", precision=10, scale=0, nullable=true)
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="units_for_free", type="integer", nullable=true)
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="units_free", type="integer", nullable=true)
     */
    private $unitsFree;
