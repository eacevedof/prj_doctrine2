 ...
 * AppShopShipment
 *
 * @ORM\Table(name="app_shop_shipment")
 * @ORM\Entity
 */
class AppShopShipment
{
    /**
     * @var integer
     *
     ...
     * @var integer
     *
     * @ORM\Column(name="id_transporter", type="integer", nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="load_weight", type="text", nullable=true)
     */
    private $loadWeight;
