...
$metadata->mapField(array(
   'fieldName' => 'idTransfer',
   'columnName' => 'id_transfer',
   'type' => 'integer',
   'nullable' => true,
   'options' => 
   array(
...
$metadata->mapField(array(
   'fieldName' => 'hourCreation',
   'columnName' => 'hour_creation',
   'type' => 'text',
   'nullable' => true,
   'length' => NULL,
   'options' => 
...
$metadata->mapField(array(
   'fieldName' => 'amountCash',
   'columnName' => 'amount_cash',
   'type' => 'text',
   'nullable' => true,
   'length' => NULL,
   'options' => 
