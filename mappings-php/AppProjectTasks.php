...
$metadata->mapField(array(
   'fieldName' => 'notesDetail',
   'columnName' => 'notes_detail',
   'type' => 'text',
   'nullable' => true,
   'length' => NULL,
   'options' => 
...
$metadata->mapField(array(
   'fieldName' => 'idTypePriority',
   'columnName' => 'id_type_priority',
   'type' => 'integer',
   'nullable' => true,
   'options' => 
   array(
...
$metadata->mapField(array(
   'fieldName' => 'idTypePercent',
   'columnName' => 'id_type_percent',
   'type' => 'integer',
   'nullable' => true,
   'options' => 
   array(
